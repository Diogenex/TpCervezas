...
<body>
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h2 class="text-center">Agregar nueva Cerveza</h2>
        <hr class="my-4">
        <form method="POST" action="<?=FRONT?>TipoCerveza/Nuevo" class="form-signin">
            ...
            <div class="form-group">
              <label for="Precio">Precio x Lt:</label>
        ...
        <a class="btn  btn-shadow blue" href="<?=FRONT?>TipoCerveza/Vista">Ver Cervezas</a>
        <a class="btn  btn-shadow blue" href="<?=FRONT?>TipoCerveza/borrarTodos">Borrar Todos</a>
      </div>  
      <div class="col-md-6">
      <div class="info-bubble-color">
          <div class="text-padding">
            <h2 class="text-grey linear-margin text-center">Tipos Disponibles</h2>
            <hr class="my-4">
